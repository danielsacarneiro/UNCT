...
<TABLE id="table_conteiner" class="conteiner" cellpadding="0" cellspacing="0">
    <TBODY>
        ...
        <TR>
			...
			<TR>
	            <TH class="campoformulario" nowrap>Data Início Vigência Alerta:</TH>
	            <TD class="campoformulario" colspan="3">
	            	<INPUT type="text" 
	            	       id="<?=voDemandaAlerta::$nmAtrDtInicioVigencia?>" 
	            	       name="<?=voDemandaAlerta::$nmAtrDtInicioVigencia?>" 

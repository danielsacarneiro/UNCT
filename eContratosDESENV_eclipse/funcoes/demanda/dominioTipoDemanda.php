...
Class dominioTipoDemanda extends dominio{	
	...
	static $CD_TIPO_DEMANDA_CONTRATO_REVISAO = 7;
	...
	static $DS_TIPO_DEMANDA_CONTRATO_REAJUSTE = "Reajuste";
	static $DS_TIPO_DEMANDA_CONTRATO_MATER = "Contrato Mater";
	static $DS_TIPO_DEMANDA_CONTRATO_REVISAO = "Revisão";
	...
	static function getColecao(){
		return array(				
				...
				self::$CD_TIPO_DEMANDA_CONTRATO_REVISAO => self::$DS_TIPO_DEMANDA_CONTRATO_REVISAO,

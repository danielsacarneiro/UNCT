    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
	            ...
	            <TD class="campoformulario" colspan="3"><textarea rows="5" cols="80" id="<?=voDemandaTramitacao::$nmAtrTexto?>" name="<?=voDemandaTramitacao::$nmAtrTexto?>" class="camporeadonly" readonly><?php echo($vo->textoTram);?></textarea>
				</TD>
	        </TR>
	        <TR>

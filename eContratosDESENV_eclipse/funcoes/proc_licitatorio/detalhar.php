    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
	            ...
	            <TD class="campoformulario" colspan="3">
	            <textarea rows="5" cols="80" id="<?=voProcLicitatorio::$nmAtrObjeto?>" name="<?=voProcLicitatorio::$nmAtrObjeto?>" class="camporeadonly" readonly><?php echo($vo->objetos); required?></textarea>
				</TD>
	        </TR>	        
			<TR>

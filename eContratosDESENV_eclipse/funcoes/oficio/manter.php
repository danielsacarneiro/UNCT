    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" nowrap width="1%"><?php echo $selectExercicio->getHtmlCombo(voOficio::$nmAtrAno,voOficio::$nmAtrAno, $filtro->ano, true, "camponaoobrigatorio", false, "required");?></TD>
                <TH class="campoformulario" nowrap width="1%">Setor:</TH>
                <TD class="campoformulario"><?php echo $comboSetor->getHtmlCombo(voOficio::$nmAtrCdSetor,voOficio::$nmAtrCdSetor, $filtro->cdSetor, true, "camponaoobrigatorio", true, "required");?></TD>
            </TR>            
			<TR>

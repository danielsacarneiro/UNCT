	...
	function validarInclusao($vo){
		...
		if(isAtributoValido($dtAssinatura)){
			...
			if(!$naovalidadata && !isDiaUtil($dtAssinatura)){
				$msg = "Data de assinatura inv�lida: verifique se o dia � �til.";
				$msg .= "<br><u>ATEN��O</u>: se o documento j� foi assinado, marque, em 'Caracter�sticas', a op��o '".dominioTipoDemandaContrato::$DS_NAO_VALIDA_DATA."'";

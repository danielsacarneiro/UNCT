...
function popMe(pUrlJanela, pNmJanela, inComToolBar){
    toolbar = "yes";
    if(inComToolBar)
        toolbar = "no";
    ...
    var W = 500; 
    var H = 500; 
    var parametros = "width=" + W + ", height=" + H +", menubar=no, scrollbars=yes, toolbar=" + toolbar +", status=yes, resizable=yes, left=0, top=0, screenX=0, screenY=0";
    var janelaAuxiliar = window.open(pUrlJanela,
                                     pNmJanela,
                                     parametros);        
    //window.open(url,"teste",s) ;
} 
// --> 

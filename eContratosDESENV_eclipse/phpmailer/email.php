...
$mail->Host = "correio.sefaz.pe.gov.br"; // Endereço do servidor SMTP
$mail->Port= "25"; // Endereço do servidor SMTP
//$mail->SMTPAuth = true; // Usa autenticação SMTP? (opcional)
//$mail->SMTPSecure = 'ssl';
$mail->Username = 'daniel.ribeiro@sefaz.pe.gov.br'; // Usuário do servidor SMTP
